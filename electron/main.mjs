...
function buildPromptWithContext(projectRootPath, sourceFolderPath, resumeContext, taskPayload, frameDescriptors) {
  ...
  return [
    ...
    'Use categories for broad parent concepts that users may search as upper-level words, such as 음식, 음료, 옷, 사람, 동물, 신체, 차, 자연.',
    'Use keywords for concrete visible items or specific scene terms, such as 계란, 짜장면, 드레스, 정장, 어깨.',
    'When a concrete keyword belongs to a broader concept, include both: put the broad term in categories and the specific term in keywords.',
